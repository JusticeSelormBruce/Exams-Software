...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ url('exam/setup') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-calculator"></i> <span>Generate Question</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                        ...
                        @foreach($exams as $exam)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('exam.show', [$exam->id]) }}" class="btn btn-success">Print Question</a>&nbsp;&nbsp;
                                    &nbsp;&nbsp;
                                    <a href="{{ route('exam.scheme', [$exam->id]) }}" class="btn bg-teal">Print Marking Scheme</a>
                                    &nbsp;
                                    ...
                                    <form id="delete-form-{{ $exam->id }}" action="{{ route('exam.destroy', [$exam->id]) }}"
