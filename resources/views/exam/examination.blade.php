    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form id="examform" action="{{ url('exam/store') }}" METHOD="POST">
                        {{ csrf_field() }}
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <textarea id="header" name="header">
                                                ...
                                                @if($school)<h2 style="text-align: center;">{{ $school->name }}</h2>@endif
                                                @if($department)<h3 style="text-align: center;">{{ $department->name }}</h3>@endif
                                                @if($category == 'term')
                                                ...
                                                @endif
                                                <h3 style="text-align: center;">{{ $subject->code }} @if($subject->code):@endif {{ $subject->name }} (3 Credits)</h3>
