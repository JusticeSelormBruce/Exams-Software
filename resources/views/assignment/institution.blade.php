...
<div class="row">
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div id="info" class="box-body">
                <p>Information of Admin will be displayed here.</p>
            </div>
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-title">Assign Administrator to Institution</div>
            </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="user" id="user">
                            <option value="">Please Select an Administrator</option>
