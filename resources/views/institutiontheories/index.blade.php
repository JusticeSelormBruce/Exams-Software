...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ url('theory/setup') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> Add New Theory Question</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('theory.show', [$theory->id]) }}">{!! $theory->question !!}</a>
                                </td>
                                <td>
                                    {!! $theory->answer !!}
                                </td>
                                <td class="text-center">
                                    <a class="btn bg-olive" href="{{ route('theory.edit',[$theory->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <form id="delete-form-{{ $theory->id }}" action="{{ route('theory.destroy', [$theory->id]) }}"
