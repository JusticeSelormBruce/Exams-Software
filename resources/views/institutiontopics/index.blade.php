...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ route('topic.create') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> Add New Topic</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('topic.show', [$topic->id]) }}"><i class="fa fa-eye"></i> {{ $topic->name }}</a>
                                </td>
                                <td>
                                    {{ $topic->subject->name }} - {{ $topic->subject->subjectable->name }}
                                </td>
                                <td class="text-center">
                                    <a class="btn bg-olive" href="{{ route('topic.edit',[$topic->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <form id="delete-form-{{ $topic->id }}" action="{{ route('topic.destroy', [$topic->id]) }}"
