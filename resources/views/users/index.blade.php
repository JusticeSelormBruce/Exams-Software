...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ route('users.create') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> Add New Lecturers/Teacher</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Lecturer/Teachers</h3>
                </div>
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('users.show', [$user->id]) }}"><i class="fa fa-eye"></i> {{ $user->name }}</a>
                                </td>
                                <td>
                                    {{ $user->email }}
                                </td>
                                <td class="text-center">
                                    <a class="btn bg-olive" href="{{ route('users.edit',[$user->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
