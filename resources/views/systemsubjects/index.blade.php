...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ route('system-subjects.create') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> Add New Subject</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('system-subjects.show', [$subject->id]) }}"><i class="fa fa-eye"></i> {{ $subject->name }}</a>
                                </td>
                                <td>
                                    {{ $subject->subjectable->name }}
                                </td>
                                <td class="text-center">
                                    <a class="btn bg-olive" href="{{ route('system-subjects.edit',[$subject->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <form id="delete-form-{{ $subject->id }}" action="{{ route('system-subjects.destroy', [$subject->id]) }}"
