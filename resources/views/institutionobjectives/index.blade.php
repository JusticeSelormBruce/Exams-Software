...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <a href="{{ url('objective/setup') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> Add New Objective Question</a>
            <br>
        </div>
        <div class="col-md-9">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('objective.show', [$objective->id]) }}">{!! $objective->question !!}</a>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <a class="btn bg-olive" href="{{ route('objective.edit',[$objective->id]) }}"><i class="fa fa-edit"></i> Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <form id="delete-form-{{ $objective->id }}" action="{{ route('objective.destroy', [$objective->id]) }}"
