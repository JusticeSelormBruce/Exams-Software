...
class ObjectivesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('objectives.index', ['objectives' => $objectives] );
    }
    ...
    {
        $topic = Topic::find($id);
        return view('objectives.create', ['topic' => $topic]);
    }
    ...
    {
        return view('objectives.show', ['objective' => $objective]);
    }
    ...
    public function update(Request $request, Objective $objective)
    {
        ...
        if($updatedObjective){
            return redirect()->route('objectives.show', [$objective->id])->with('success', 'Objective Question Updated Successfully');
        }
    ...
    {
        if($objective->delete()){
            return redirect()->route('objectives.index')->with('success','Objective Question Deleted Successfully');
        }
        return back();
    }
    ...
    public function setup()
    {
        ...
        return view('objectives.setup', ['institutions' => $institutions]);
    }
